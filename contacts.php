...
<head>
	...
	<title>Contact Us | Polaris Capital Group</title>
			      ...
			      <!-- Navigation -->
					<nav class="nav-main" style="height:138px;">
						<ul data-breakpoint="992" class="flexnav"  >
							...
							<li class="active" style="height: 139px;"><a href="contacts.php">CONTACT US</a></li>
						</ul>
					</nav>
					<!-- Navigation / End -->
		...
		<div class="main" role="main">
			...
			<section class="page-content">
				...
				<div class="container">
					...
					<center>
					Set up an appointment with your private banking team by completing this form. 
                    <p>
					</center>
					</div>
					<br /> 
					...
					<div class="row">
                        ...
                        <p>We guarantee that our knowledgeable associates will deliver superior service and fast results to help you on your way in growing your business. We have a solid foundation in San Diego, but we also serve businesses nationally. Feel free to contact us with any questions concerning cash advances for businesses, working capital loans, and many more services. Simply fill out the form with your Name, Business Name, Email, and a short paragraph detailing how we can help you and your business. We will respond as soon as possible.
							...
							<p>
							A relationship manager will contact you within 1 business day.
							  <br>
							  For more information about our privacy  policy, click <a href="privacy-policy.php">here</a>.
							</p>
						</div>
						<div class="col-md-3">
								...
								<div class="widget-content">
									<ul class="contacts-info-list">
										<li>
											...
											<div class="info-item">
												Polaris Capital Group<br />1 America Plaza 600<br /> West Broadway Suite 350<br />San Diego, CA 92101
											</div>
										</li>
										<li>
										...
										<li>
											<i class="fa fa-clock-o" style="color:white; background:#004664;"></i>
											<div class="info-item">
